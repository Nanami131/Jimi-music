...
import com.example.jimi.model.domain.ResetPasswordRequest;
...
public class ConsumerController {
    ...
    public R addUser(@Validated(ValidationGroups.CreateValidationGroup.class)  @RequestBody ConsumerRequest registryRequest) {
